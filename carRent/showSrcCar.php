...
$sql = "SELECT CarID, CarName, CarModel, CarType, CarNo, carprice, isreserve FROM cars,parking,parking_car WHERE cars.CarID=parking_car.cars_CarID AND parking.ParID=parking_car.parcID and parking.ParID='".$_POST['src']."';";
$res = mysql_query($sql);
